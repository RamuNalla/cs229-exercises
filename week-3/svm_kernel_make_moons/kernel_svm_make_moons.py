...
linear_svm = SVC(kernel="linear", C = 1.0, random_state=42)       # random_state ensure model trains same way every time you run it as it involves randomness wih the underlying optimization
