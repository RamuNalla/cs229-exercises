...
wandb.init(
    project="gaussian_discriminant_analysis_project",  # Name of the project on wandb.ai
    config={
        "samples_0": 300,
        "samples_1": 500,
...
samples_0 = config.samples_0
samples_1 = config.samples_1
...
wandb.log({
    "phi_custom": phi,
    "mu_0_custom": mu_0[0], "mu_0_x2": mu_0[1],
    "mu_1_custom": mu_1[0], "mu_1_x2": mu_1[1],
})
...
wandb.log({
    ...
    "log_loss_gda_custom": log_loss(y, y_pred),
    "f1_score_gda_custom": f1_score(y, y_pred)
    })
...
wandb.log({"accuracy_lda": accuracy_lda})
